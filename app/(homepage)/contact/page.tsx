...
function Contact({}: Props) {
    ...
    const onSubmit: SubmitHandler<Inputs> = (formData) => {
        window.location.href = `mailto:kiarawoods2707@gmail.com?subject=${formData.subject}&
body=Hi, my name is ${formData.name}. ${formData.message} (${formData.email})`;
  ...
  return (
    ...
    '>
      <h3 className='absolute lg:top-32
        md:top-16
        top-12
      ...
      <div className='flex flex-col space-y-10'>
        <h4 className='md:text-3xl lg:text-4xl  font-semibold text-center'>
            ...
            <span className='decoration-[pink]/50 underline'>
                Lets Talk
            </span>
        </h4>
        <div className='space-y-10'>
            ...
            <p className='text-2xl'>+27 76 235 6734</p>
            </div>
            <div className='flex items-center space-x-5 justify-center'>
            <MapPinIcon className='text-[pink] h-7 w-7 animate-pulse'/>
            <p className='text-2xl'>world</p>
            </div>
            <div className='flex items-center space-x-5 justify-center'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-2 w-fit mx-auto'>
                ...
                <button type='submit' className=' bg-[pink] py-5 px-10 rounded-md text-black 
                font-bold text-lg'>
                    Submit
                </button>
        </form>
